...
import java.io.File
import network.ClientMeta

import java.net.InetAddress

object Parser {
  def parse(args: Array[String]): ClientMeta = {
    ...
    new ClientMeta(inputDirPaths, outputDirPath, masterIP, masterPort, InetAddress.getLocalHost.getHostAddress)
  }
}